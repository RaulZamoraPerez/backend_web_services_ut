...
import { 
  ...
  toggleBannerStatus,
  updateBannerOrder
} from '../controllers/feriasProfesiograficasController';
import { uploadFeriasProfesiograficasImagen } from '../middleware/feriasProfesiograficasUpload';
import { uploadFeriasProfesiograficasDocumento, validateUploadedFeriasProfesiograficasDocumento, validateUploadedFeriasProfesiograficasDocumentoOptional } from '../middleware/feriasProfesiograficasDocumentoUpload';
...
import {
  ...
  actualizarDocumento,
  eliminarDocumento
} from '../controllers/feriasProfesiograficasDocumentosController';
...
router.post('/cursos', authenticateToken, uploadFeriasProfesiograficasImagen, createCurso);
router.put('/cursos/reorder', authenticateToken, updateCursoOrder);
router.put('/cursos/:id', authenticateToken, uploadFeriasProfesiograficasImagen, updateCurso);
...
router.post('/documentos', authenticateToken, uploadFeriasProfesiograficasDocumento.single('archivo'), validateUploadedFeriasProfesiograficasDocumento, crearDocumento);
router.put('/documentos/:id', authenticateToken, uploadFeriasProfesiograficasDocumento.single('archivo'), validateUploadedFeriasProfesiograficasDocumentoOptional, actualizarDocumento);
...
router.post('/banners', authenticateToken, uploadFeriasProfesiograficasImagen, createBanner);
router.put('/banners/reorder', authenticateToken, updateBannerOrder);
router.put('/banners/:id', authenticateToken, uploadFeriasProfesiograficasImagen, updateBanner);
