...
import { 
  ...
  toggleBannerStatus,
  updateBannerOrder
} from '../controllers/promocionInstitucionalController';
import { uploadPromocionInstitucionalImagen } from '../middleware/promocionInstitucionalUpload';
import { uploadPromocionInstitucionalDocumento, validateUploadedPromocionInstitucionalDocumento, validateUploadedPromocionInstitucionalDocumentoOptional } from '../middleware/promocionInstitucionalDocumentoUpload';
...
import {
  ...
  actualizarDocumento,
  eliminarDocumento
} from '../controllers/promocionInstitucionalDocumentosController';
...
router.post('/cursos', authenticateToken, uploadPromocionInstitucionalImagen, createCurso);
router.put('/cursos/reorder', authenticateToken, updateCursoOrder);
router.put('/cursos/:id', authenticateToken, uploadPromocionInstitucionalImagen, updateCurso);
...
router.post('/documentos', authenticateToken, uploadPromocionInstitucionalDocumento.single('archivo'), validateUploadedPromocionInstitucionalDocumento, crearDocumento);
router.put('/documentos/:id', authenticateToken, uploadPromocionInstitucionalDocumento.single('archivo'), validateUploadedPromocionInstitucionalDocumentoOptional, actualizarDocumento);
...
router.post('/banners', authenticateToken, uploadPromocionInstitucionalImagen, createBanner);
router.put('/banners/reorder', authenticateToken, updateBannerOrder);
router.put('/banners/:id', authenticateToken, uploadPromocionInstitucionalImagen, updateBanner);
