...
const secureStorage = multer.diskStorage({
    destination: (req, file, cb) => {
        const uploadPath = path.join(__dirname, '../../uploads/educacion_continua/documentos');
...
export const uploadEducacionContinuaDocumento = multer({
...
export const validateUploadedEducacionContinuaDocumento = (req: Request, res: any, next: any) => {
    if (!req.file) {
...
export const validateUploadedEducacionContinuaDocumentoOptional = (req: Request, res: any, next: any) => {
    if (!req.file) {
        return next();
    }
