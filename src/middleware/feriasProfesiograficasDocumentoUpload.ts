...
const secureStorage = multer.diskStorage({
    destination: (req, file, cb) => {
        const uploadPath = path.join(__dirname, '../../uploads/ferias_profesiograficas/documentos');
...
export const uploadFeriasProfesiograficasDocumento = multer({
...
export const validateUploadedFeriasProfesiograficasDocumento = (req: Request, res: any, next: any) => {
    if (!req.file) {
...
export const validateUploadedFeriasProfesiograficasDocumentoOptional = (req: Request, res: any, next: any) => {
    if (!req.file) {
        return next();
    }
