...
const secureStorage = multer.diskStorage({
    destination: (req, file, cb) => {
        const uploadPath = path.join(__dirname, '../../uploads/visitas_guiadas/documentos');
...
export const uploadVisitasGuiadasDocumento = multer({
...
export const validateUploadedVisitasGuiadasDocumento = (req: Request, res: any, next: any) => {
    if (!req.file) {
...
export const validateUploadedVisitasGuiadasDocumentoOptional = (req: Request, res: any, next: any) => {
    if (!req.file) {
        return next();
    }
