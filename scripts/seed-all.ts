 ...
 * Versión de desarrollo en TypeScript
...
import seedEducacionContinua from './seed-educacion-continua';

// Configuración de la base de datos
const isProduction = process.env.NODE_ENV === 'production';
const devMode = process.argv.includes('--dev') || !isProduction;

// Imagen por defecto para producción
...
// ============================================================================
// MODELOS — Usar modelos del proyecto para respetar timestamps y convenciones
// ============================================================================

// Se importan: User, Carrera, NosotrosContent (definidos en src/models)
...
async function seedAdmin() {
  ...
  try {
    ...
    // Use camelCase properties as defined in the User model
...
/**
 * 2. Poblar contenido de Nosotros
 */
async function seedNosotros() {
  ...
  try {
    ...
    // En producción, normalizar imágenes
    if (!devMode) {
...
/**
 * 4. Poblar Extensión Universitaria
 */
...
export { seedAdmin, seedNosotros, seedCarreras, seedExtensionUniversitaria };
